        ...
        <section class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="row justify-content-center">
                ...
                <div class="card mb-3">
                    ...
                    <form action="/postregister" method="POST" class="row g-3 needs-validation" novalidate>
                        @csrf
                        <div class="col-12">
...
{{-- 
                        ...
                        <input type="text" name="telp" class="form-control" id="yourName" required>
                        </div> --}}
{{-- 
                        <div class="col-12">
                        <label for="yourFoto" class="form-label">Foto</label>
                        <input type="file" name="foto" class="form-control" id="yourName" required>
                        </div>  --}}
                ...
                <div class="credits">
                    ...
                    Designed by <strong>Zaky Abdillah</strong>
                </div>
